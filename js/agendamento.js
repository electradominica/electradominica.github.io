        ...
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                ...
                showModal(`
                    ...
                    <p>Chave Pix:</p>  
                    <p id="chavePix" class="pix-key">suachavepix@gmail.com</p>
                    <button id="copiarPix" class="copy-button">Copiar Chave Pix</button>
                    <a id="linkPacote" href="https://wa.me/5513991493094?text=Olá%Electra!%20Realizei%20o%20agendamento%20da%20nossa%20video-chamada.%20Vou%20te%20passar%20o%20comprovante%20aqui%20para%20você%20confirmar%20no%20sistema..." target="_blank"><button class="payment-button">Já paguei!</button></a>
